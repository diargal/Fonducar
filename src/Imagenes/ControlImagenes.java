...
public class ControlImagenes {
    ...
    public static final ImageIcon CUATRO = new ImageIcon("src/Imagenes/pelotas/4.png");
    public static final ImageIcon CINCO = new ImageIcon("src/Imagenes/pelotas/5.png");
    public static final ImageIcon SEIS = new ImageIcon("src/Imagenes/pelotas/6.png");
