...
public class Mensajes {
    ...
    public static final String COPIA = "Creación de backup de la base de datos.";
    public static final String RESTAURACION = "Restauración de backup de la base de datos.";
